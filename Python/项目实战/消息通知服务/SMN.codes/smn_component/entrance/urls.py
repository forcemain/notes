...
from utils.rest.auth.token.views import CasTokenAuthView
from cas_app.restapi.v1.urls import urlpatterns as cas_api_v1_urlpatterns
from smn_app.restapi.v1.urls import urlpatterns as smn_api_v1_urlpatterns


restv1_urls = []
restv1_urls.extend(cas_api_v1_urlpatterns)
restv1_urls.extend(smn_api_v1_urlpatterns)


urlpatterns = [
    url(r'^v1/', include((restv1_urls, 'restapi-v1'))),
    url(r'^v1/auth/tokens/$', CasTokenAuthView.as_view(), name='restapi-v1-auth-tokens'),
]
