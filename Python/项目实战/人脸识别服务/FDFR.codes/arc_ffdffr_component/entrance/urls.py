...
from ffdffr_app.restapi.v1.urls import urlpatterns as ffdffr_api_v1_urlpatterns


restv1_urls = []
restv1_urls.extend(oauth2_api_v1_urlpatterns)
restv1_urls.extend(ffdffr_api_v1_urlpatterns)
...
urlpatterns += [
    url(r'^$', lambda request: JsonResponse({'service': 'arc_ffdffr_component', 'version': '1.0'}), name='service')
]
